...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_gallery_content_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum_pages_blocks_gallery_content_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum_pages_blocks_gallery_type" AS ENUM('canvas', 'postcard', 'slider', 'tiles', 'twoColumns');
  CREATE TYPE "public"."enum_pages_blocks_gallery_media_placement" AS ENUM('left', 'right');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_gallery_content_link_type" AS ENUM('reference', 'custom');
  CREATE TYPE "public"."enum__pages_v_blocks_gallery_content_link_appearance" AS ENUM('default', 'outline');
  CREATE TYPE "public"."enum__pages_v_blocks_gallery_type" AS ENUM('canvas', 'postcard', 'slider', 'tiles', 'twoColumns');
  CREATE TYPE "public"."enum__pages_v_blocks_gallery_media_placement" AS ENUM('left', 'right');
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_gallery_content" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"media_id" integer,
  	"rich_text" jsonb,
  	"link_type" "enum_pages_blocks_gallery_content_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum_pages_blocks_gallery_content_link_appearance" DEFAULT 'default'
  );
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_gallery" (
  	...
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"type" "enum_pages_blocks_gallery_type" DEFAULT 'tiles',
  	"disable_label" boolean DEFAULT false,
  	"media_placement" "enum_pages_blocks_gallery_media_placement" DEFAULT 'left',
  	"block_name" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_gallery_content" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"media_id" integer,
  	"rich_text" jsonb,
  	"link_type" "enum__pages_v_blocks_gallery_content_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_appearance" "enum__pages_v_blocks_gallery_content_link_appearance" DEFAULT 'default',
  	"_uuid" varchar
  );
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_gallery" (
  	...
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"type" "enum__pages_v_blocks_gallery_type" DEFAULT 'tiles',
  	"disable_label" boolean DEFAULT false,
  	"media_placement" "enum__pages_v_blocks_gallery_media_placement" DEFAULT 'left',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_gallery_content" ADD CONSTRAINT "pages_blocks_gallery_content_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_gallery_content" ADD CONSTRAINT "pages_blocks_gallery_content_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_gallery"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_gallery_content" ADD CONSTRAINT "_pages_v_blocks_gallery_content_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_gallery_content" ADD CONSTRAINT "_pages_v_blocks_gallery_content_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_gallery"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_gallery_content_order_idx" ON "pages_blocks_gallery_content" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_gallery_content_parent_id_idx" ON "pages_blocks_gallery_content" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_gallery_content_media_idx" ON "pages_blocks_gallery_content" USING btree ("media_id");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_gallery_content_order_idx" ON "_pages_v_blocks_gallery_content" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_gallery_content_parent_id_idx" ON "_pages_v_blocks_gallery_content" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_gallery_content_media_idx" ON "_pages_v_blocks_gallery_content" USING btree ("media_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_gallery_content" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_gallery_content" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_gallery_content_link_type";
  DROP TYPE "public"."enum_pages_blocks_gallery_content_link_appearance";
  DROP TYPE "public"."enum_pages_blocks_gallery_type";
  DROP TYPE "public"."enum_pages_blocks_gallery_media_placement";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_gallery_content_link_type";
  DROP TYPE "public"."enum__pages_v_blocks_gallery_content_link_appearance";
  DROP TYPE "public"."enum__pages_v_blocks_gallery_type";
  DROP TYPE "public"."enum__pages_v_blocks_gallery_media_placement";
